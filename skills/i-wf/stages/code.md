...
3. **Read the visual specifications file:** `docs/workflow/features/<feature-id>/specs/<NN>-<chunk-slug>-specs.md`
   This document is your visual reference for exact colors, typography, spacing, animations, and device compatibility.

4. Read project patterns from `CLAUDE.md`, `Agent.md`, or `Gemini.md` if present.

5. Read the feature's `INDEX.md` to know all acceptance criteria for this chunk.
...
7. **Visual specification compliance check** before gate:
   - Compare each visual component against the specifications in `docs/workflow/features/<feature-id>/specs/<NN>-<chunk-slug>-specs.md`
...
11. Update `INDEX.md`: chunk stage → `Code`, update timestamp.

12. Append to `log.md`: Code complete, gate check summary.
