...
3. **Visual specification verification:**
   a. Read the visual specifications file: `docs/workflow/features/<feature-id>/specs/<NN>-<chunk-slug>-specs.md`
...
9. Update `INDEX.md`: chunk stage to `QA`, update timestamp.
